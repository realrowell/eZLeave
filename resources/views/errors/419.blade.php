            ...
            <div class="row">
                <div class="col">
                    <article class="text-center" style=" padding-top: 5%">
                        <h1 class="text-start" style="font-family: 'Poppins', sans-serif; font-size: 10rem">419</h1>
                        <p class="text-start " style="margin-top: -10px; font-size: 3rem">Page Expired</p>
                        <p class="text-start " style="margin-top: 50px; font-size: 2rem">Oops! The page you're trying to access has been expired. Please go back to the previous page and reload the page.</p>
                        <p class="text-start" id="signature" style=" font-size: 2rem"><a href="{{ route('index') }}">or go back to home </a></p>
                    </article>
                </div>
            </div>
