            ...
            <div class="row">
                <div class="col">
                    <article class="text-center" style=" padding-top: 5%">
                        <h1 class="text-start" style="font-family: 'Poppins', sans-serif;">Site is temporarily unavailable.</h1>
                        <p class="text-start mt-4">Scheduled maintenance is currently in progress. Please check back soon.</p>
                        <p class="text-start mt-4">We apologize for any inconvenience.</p>
