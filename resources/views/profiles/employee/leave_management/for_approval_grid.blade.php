        ...
        <div class="col-lg-3 col-md-6 col-sm-10">
            <div class="card w-100 p-2 shadow">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h4 class="card-title text-center">{{ optional($partial_leave_application->leavetypes)->leave_type_title }}</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <h6>
                                ...
                                {{ optional(optional($partial_leave_application->employees->users)->suffixes)->suffix_title }}
                            </h6>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-12 col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <h4 id="datetime_startdate">{{ \Carbon\Carbon::parse($partial_leave_application->start_date)->format('M d, Y') }} ({{ $partial_leave_application->start_of_date_parts->day_part_title }})</h4>
                                            </div>
                                            <div class="col-6">
                                                <label for="enddate">
                                                    <h6>End date</h6>
                                                </label>
                                                <h4 id="datetime_enddate">{{ \Carbon\Carbon::parse($partial_leave_application->end_date)->format('M d, Y') }} ({{ $partial_leave_application->end_of_date_parts->day_part_title }})</h4>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
