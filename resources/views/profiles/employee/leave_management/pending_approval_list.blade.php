                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    @if ($leave_application->status_id == 'sta-1001')
                                                        ...
                                                        <form action="{{ route('leave_application_cancellation', $leave_application->reference_number) }}" onsubmit="onClickApprove()">
                                                            @csrf
                                                                ...
                                                                <div class="col-lg-8 col-md-12 col-sm-12">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            ...
                                                                            <input type="text" class="form-control text-start" value="{{ optional($leave_application->approvers->users)->first_name }} {{ optional($leave_application->approvers->users)->last_name }} {{ optional($leave_application->approvers->users->suffixes)->suffix_title }}" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mt-2">
                                                                        <div class="col">
