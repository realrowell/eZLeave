        ...
        <div class="col bg-light shadow mb-5">
            <div class="row p-3">
                ...
                <div class="col-12 col-lg-6 text-end mt-2">
                    <a href="{{ route('profile_leave_management_history_grid') }}" class="ms-1 me-1 custom-primary-button rounded-0 p-2 @yield('grid_view_active')">
                        <i class='fs-6 bx bxs-grid-alt' ></i>
                        Grid View
                    </a>
                    <a href="{{ route('profile_leave_management_history_list') }}" class="ms-1 me-1 custom-primary-button rounded-0 p-2 @yield('list_view_active')">
