                    ...
                    @forelse ($partial_leave_applications as $partial_leave_application)
                        <tr>
                            ...
                            <td class="d-flex gap-2 pb-3">
                                ...
                                <a href="{{ route('employee_leave_approval',$partial_leave_application->reference_number) }}" class="btn btn-sm btn-success text-center" id="submit_button" onclick="onClickApprove()">Approve</a>
                                <a href="#" class="btn btn-sm btn-danger text-center" data-bs-toggle="modal" data-bs-target="#rejectleaveModal{{ $partial_leave_application->reference_number }}">Reject</a>
                            </td>
                        </tr>
                        <!-- reject details Modal -->
                            <div class="modal fade" id="rejectleaveModal{{ $partial_leave_application->reference_number }}" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <form action="{{ route('employee_leave_rejection',$partial_leave_application->reference_number) }}" method="PUT" onsubmit="onClickApprove()">
                                            @csrf
                            ...
                            <div class="modal fade" id="detailsModal{{ $partial_leave_application->reference_number }}" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                                    ...
                                                    <div class="col-lg-9 col-md-12 col-sm-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <h4 id="datetime_startdate">{{ \Carbon\Carbon::parse($partial_leave_application->start_date)->format('M d, Y') }}</h4>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <h5 id="datetime_startdate">{{ $partial_leave_application->start_of_date_parts->day_part_title }}</h5>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <h4 id="datetime_startdate">{{ \Carbon\Carbon::parse($partial_leave_application->end_date)->format('M d, Y') }}</h4>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <h5 id="datetime_startdate">{{ $partial_leave_application->end_of_date_parts->day_part_title }}</h5>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mt-4">
                                                            <div class="col">
                                                                ...
                                                                <h5>
                                                                    {{ optional($partial_leave_application->employees->users)->first_name }}
                                                                    {{ optional($partial_leave_application->employees->users)->last_name }}
                                                                    {{ optional($partial_leave_application->employees->users->suffixes)->suffix_title }}
                                                                </h5>
                                                            </div>
                                                        </div>
                                                        <div class="row mt-2">
                                                        ...
                                                        <div class="row mt-2">
                                                            <div class="col">
                                                                ...
                                                                @forelse ($leave_application_notes as $leave_application_note)
                                                            ...
                                                            <div class="col">
                                                                <label class="" for="update">
                                                                    @if ($partial_leave_application->status_id == 'sta-1001' || $partial_leave_application->status_id == 'sta-1003')
                                                                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#updatedetailsModal{{ $partial_leave_application->reference_number }}">
                                                                            Add note / comment
                                                                        </button>
                                                                    @endif
                                                                </label>
                                                        ...
                                                        <div class="row mt-2">
                                                            <div class="col">
                                                                ...
                                                                @if ($partial_leave_application->status_id == 'sta-1003')
                                                                    @foreach ($leave_approvals as $leave_approval)
                                                                        @if ($leave_approval->leave_application_reference == $partial_leave_application->reference_number)
                                                                            ...
                                                                            @elseif ($leave_approval->status_id == 'sta-1002')
                                                                                <p class="bg-success text-light ps-3">{{ $leave_approval->statuses->status_title }} - {{ optional($leave_approval->approvers)->first_name." ". optional($leave_approval->approvers)->last_name}} {{ \Carbon\Carbon::parse($leave_approval->created_at)->format('(M d, Y h:i:sa)')}}</p>
                                                                            @endif
                                                                        @endif
                                                                    @endforeach
                                                                @endif
                                        ...
                                        <div class="modal-footer">
                                            <form action="{{ route('employee_leave_rejection',$partial_leave_application->reference_number) }}" onsubmit="onClickApprove()">
                                                @csrf
                                                <button type="submit" class="btn btn-danger" data-bs-dismiss="modal">Reject</button>
                                            </form>
                                            <form action="{{ route('employee_leave_approval',$partial_leave_application->reference_number) }}" onsubmit="onClickApprove()">
                                                @csrf
                        ...
                        <!-- update details Modal -->
                            <div class="modal fade" id="updatedetailsModal{{ $partial_leave_application->reference_number }}" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <form action="{{ route('create_note_employee_leaveapplication',['leave_application_rn'=>$partial_leave_application->reference_number]) }}" id="form_submit" method="POST" onsubmit="submitButtonDisabled()" enctype="multipart/form-data">
                                            @csrf
                                            @method('POST')
                                            <div class="modal-body">
                                                <div class="container-fluid text-start">
                                                        ...
                                                        <div class="col-lg-8 col-md-12 col-sm-12">
                                                            ...
                                                            <div class="row ">
                                                                <div class="col-6">
                                                                    ...
                                                                    <input type="date" class="form-control" id="startdate" name="startdate" placeholder="" value="{{ \Carbon\Carbon::parse($partial_leave_application->start_date)->format('Y-m-d') }}" disabled>
                                                                </div>
                                                                <div class="col-6">
                                                                    <label for="enddate">
                                                                        <h6>End date</h6>
                                                                    </label>
                                                                    <input type="date" class="form-control" id="enddate" name="enddate" placeholder="" value="{{ \Carbon\Carbon::parse($partial_leave_application->end_date)->format('Y-m-d') }}" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <input type="text" name="duration" placeholder="" id="duration_input_update" class="form-control" value="{{ $partial_leave_application->duration }}" disabled/>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-4">
                                                                <div class="col">
                                                                    ...
                                                                    <h5>{{ optional($partial_leave_application->employees->users)->first_name }} {{ optional($partial_leave_application->employees->users)->last_name }} {{ optional($partial_leave_application->employees->users->suffixes)->suffix_title }}</h5>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-2">
                                                                <div class="col">
                                                            ...
                                                            <div class="row mt-2">
                                                                <div class="col">
                                                                    ...
                                                                    @if ($partial_leave_application->status_id == 'sta-1001')
                                                                        <p class="bg-secondary text-light ps-3">{{ $partial_leave_application->statuses->status_title }}</p>
                                                                    @elseif ($partial_leave_application->status_id == 'sta-1002')
                                                                        <p class="bg-success text-light ps-3">{{ $partial_leave_application->statuses->status_title }}</p>
                                                                    @elseif ($partial_leave_application->status_id == 'sta-1003')
                                                                        <p class="bg-success text-light ps-3">{{ $partial_leave_application->statuses->status_title }}</p>
                                                                    @elseif ($partial_leave_application->status_id == 'sta-1004')
                                                                        <p class="bg-danger text-light ps-3">{{ $partial_leave_application->statuses->status_title }}</p>
                                                                    @elseif ($partial_leave_application->status_id == 'sta-1005')
                                                                        <p class="bg-danger text-light ps-3">{{ $partial_leave_application->statuses->status_title }}</p>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        @if ($leave_application->status_id == 'sta-1001')
                                                                            @foreach ($leave_approvals as $leave_approval)
                                                                                @if ($leave_approval->leave_application_reference == $leave_application->reference_number)
                                                                                    <p class="bg-secondary text-light ps-3">{{ $leave_approval->statuses->status_title }} - {{ optional($leave_approval->approvers)->first_name." ". optional($leave_approval->approvers)->last_name}}</p>
                                                                                @endif
                                                                            @endforeach
                                                                        @endif
                                                                    </div>
