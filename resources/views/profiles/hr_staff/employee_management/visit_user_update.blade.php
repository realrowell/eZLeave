    ...
    <div class="row justify-content-center align-items-start d-flex gap-2 mb-5">
        ...
        <div class="col-lg-8 col-md-8 col-sm-10">
            <div class="row bg-light mt-4 z-1 p-1 ps-4 m-1 shadow">
                ...
                {{-- PROFILE Fields --}}
                <form action="{{ route('update_user',['user_id'=>$user->id,'employee_id'=>$user->employees->id,'employee_position_id'=>$user->employees->employee_positions->id]) }}" method="POST" onsubmit="submitButtonDisabled()">
                @csrf
                @method('PATCH')
                    <div class="row">
                        <div class="row mt-5">
                                ...
                                <div class="row mt-2 mb-1" >
                                    ...
                                    <div class="mb-2 col-lg-3 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="suffix" name="suffix">
                                            <option selected value="{{ optional($user->suffixes)->id }}">{{ optional($user->suffixes)->suffix_title }}</option>
                                ...
                                <div class="row mt-2 mb-1">
                                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="gender" name="gender">
                                            <option selected value="{{ optional($user->employees->genders)->id }}">{{ optional($user->employees->genders)->gender_title }}</option>
                                ...
                                <div class="row mt-2 mb-1">
                                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="marital_status" name="marital_status">
                                            <option selected value="{{ optional($user->employees->marital_statuses)->id }}">{{ optional($user->employees->marital_statuses)->marital_status_title }}</option>
                                ...
                                <div class="row mt-2 mb-1">
                                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="employment_status" name="employment_status">
                                            <option selected value="{{ optional($user->employees->employment_statuses)->id }}">{{ optional($user->employees->employment_statuses)->employment_status_title }}</option>
                                    ...
                                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="reports_to" name="reports_to">
                                            @if ( !empty(optional($user->employees->employee_positions)->reports_to_id))
                                                <option selected disabled value="{{ optional($user->employees->employee_positions)->reports_to_id }}">
                                                    {{ optional($user->employees->employee_positions->reports_tos->users)->first_name }} 
                                                    {{ optional($user->employees->employee_positions->reports_tos->users)->last_name }} 
                                                </option>
                                                @foreach ($user_reports_tos as $user_reports_to)
                                                    @if ($user_reports_to->employee_positions->subdepartments->departments->id == $user->employees->employee_positions->subdepartments->departments->id)
                                ...
                                <div class="row mt-2 mb-1">
                                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="position" name="position">
                                            <option selected disabled value="">{{ optional($user->employees->employee_positions->positions)->position_title }}</option>
                                ...
                                <div class="row mt-2 mb-1">
                                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="area_of_assignment" name="area_of_assignment">
                                            <option selected disabled value="{{ optional($user->employees->employee_positions->area_of_assignments)->id }}">{{ optional($user->employees->employee_positions->area_of_assignments)->location_address }}</option>
                                ...
                                <div class="row mt-2 mb-1">
                                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="subdepartment" name="subdepartment">
                                            <option selected disabled value="{{ optional($user->employees->employee_positions->subdepartments)->id }}">{{ optional($user->employees->employee_positions->subdepartments)->sub_department_title }}</option>
