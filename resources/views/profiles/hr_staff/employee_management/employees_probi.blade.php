        ...
        <div class="col bg-light shadow p-3 ps-4 pe-4">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8 col-lg-6 justify-content-end align-items-end text-end mt-2">
                    <a href="{{ route('hrstaff_employees_probi_grid') }}" class="ms-1 me-1 custom-primary-button rounded-0 p-2 @yield('grid_active')">
                        <i class='fs-6 bx bxs-grid-alt' ></i>
                        Grid View
                    </a>
                    <a href="{{ route('hrstaff_employees_probi_list') }}" class="ms-1 me-1 custom-primary-button rounded-0 p-2 @yield('list_active')">
