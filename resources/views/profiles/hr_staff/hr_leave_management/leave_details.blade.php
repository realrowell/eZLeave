                                                        ...
                                                        @if ($leave_application_note->author_id == $leave_application->employees->users->id)
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <p class="mt-2"> - {{ optional($leave_application_note->users)->first_name }} {{ optional($leave_application_note->users)->last_name }} at {{ $leave_application_note->created_at }}</p>
                                                                </div>
                                                            </div>
                            ...
                            <div class="row text-end mt-3">
                                <div class="col">
                                    @if ($leave_application->status_id == 'sta-1001' || $leave_application->status_id == 'sta-1003')
                                        ...
                                        <button type="submit" class="btn btn-success ms-3" id="submit_button1" onclick="onClickUpdateSubmit()">Update</button>
                                    @else
