            ...
            <table class="table table-striped table-hover bg-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td id="table_leave_types">{{ optional($leave_application->leavetypes)->leave_type_title }}</td>
                        <td id="table_start_date">{{ \Carbon\Carbon::parse($leave_application->start_date)->format('M d, Y') }}</td>
                        <td id="table_end_date">{{ \Carbon\Carbon::parse($leave_application->end_date)->format('M d, Y') }}</td>
                        <td id="table_leave_credits"></td>
                        <td id="table_filed_at">{{ \Carbon\Carbon::parse($leave_application->created_at)->format('M d, Y; h:i a') }}</td>
                        <td>
