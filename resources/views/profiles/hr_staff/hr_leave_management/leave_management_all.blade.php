...
<div class="row bg-light p-3 m-1" id="form_submit_1">
    <div class="row">
        <div class="col">
                    ...
                    <tr>
                        ...
                        <td class="d-flex gap-2 pb-3">
                            @if ( $leave_application->status_id == 'sta-1001' )
                                ...
                                <a href="{{ route('leave_application_approval', $leave_application->reference_number) }}" onclick="onClickUpdateSubmit()" class="btn btn-sm btn-success">
                                    Approve
                                </a>
