...
<div class="row p-3 mt-3 bg-light shadow">
    ...
    <div class="col-lg-9 col-md-9 col-sm-12 ps-5 pe-5 pb-5">
        <div class="row ">
            <div class="col">
                <a href="{{ route('admin_visit_employee_view',['username'=>$user->user_name]) }}" class="ms-1 me-1 p-2 ps-3 pe-3 custom-primary-button">
                    Profile
                </a>
                <a href="{{ route('visit_employee_leave_ms_view',['username'=>$user->user_name]) }}" class="ms-1 me-1 p-2 ps-3 pe-3 custom-primary-button bg-selected-warning">
                    Leave MS
                </a>
