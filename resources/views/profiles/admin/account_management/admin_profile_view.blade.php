                ...
                <div class="row mt-5">
                    ...
                    <div class="col-6 text-end">
                        @if (auth()->user()->role_id == 'rol-0001')
                            <a href="{{ route('admin_profile_update_view') }}" class="btn btn-sm btn-outline-primary ps-4 pe-4">
                                <svg class="m-1" width="18px" height="18px" viewBox="3 2 25 25">
                                    {{ svg('carbon-edit') }}
                                </svg> Update
                            </a>
                        @elseif (auth()->user()->role_id == 'rol-0002')
                            <a href="{{ route('hrstaff_profile_update') }}" class="btn btn-sm btn-outline-primary ps-4 pe-4">
                                <svg class="m-1" width="18px" height="18px" viewBox="3 2 25 25">
                                    {{ svg('carbon-edit') }}
                                </svg> Update
                            </a>
