...
<div class="container-fluid mb-4 pb-5" id="profile_body">
    ...
    <div class="row mb-4 d-flex gap-1 justify-content-center justify-content-sm-center justify-content-lg-start">
        <div class="col-lg-2 col-md-4 col-sm-5 col-5 card-menu shadow-sm align-self-stretch bg-selected-warning" style="min-height: 1rem" >
            <a href="{{ route('admin_accounts_grid') }}" class="text-light">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-12 col-md-8 col-lg-6 justify-content-end align-items-end text-end mt-2">
            ...
            <a href="#AddEmployee" class="col p-2 ms-2 custom-primary-button custom-rounded-top"  data-bs-toggle="modal" data-bs-target="#AddEmployeeModal">
                <i data-toggle="tooltip" title="list view" class="add-icon" >
                    <svg class="mb-1" width="30px" height="30px" viewBox="-2.4 -2.4 28.80 28.80">{{ svg('css-add') }}</svg>
                </i>
                Add Employee
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl">
                        <div class="modal-content">
                                ...
                                <div class="modal-body" id="form_submit">
                                    <div class="container-fluid text-start">
                                        <div class="row">
                                            <ul class="nav nav-pills mb-3 justify-content-center align-items-center mx-auto list-inline" id="pills-tab" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link active" id="pills-NewEmployee-tab" data-bs-toggle="pill" data-bs-target="#pills-NewEmployee" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                                                        New Employee
                                                    </button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="pills-ExistingEmployee-tab" data-bs-toggle="pill" data-bs-target="#pills-ExistingEmployee" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
                                                        Existing Employee
                                                    </button>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-NewEmployee" role="tabpanel" aria-labelledby="pills-NewEmployee-tab">
                                                    {{-- New Employee --}}
                                                        <form action="#" method="POST" onsubmit="submitButtonDisabled()">
                                                            @csrf
                                                            <div class="row ps-5 p-3 pe-5 text-dark">
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-12 border-start border-warning border-5">
                                                                    ...
                                                                    <div class="row mt-2 mb-1">
                                                                        ...
                                                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                                                            <label for="sap_id"><h6 class="profile-title">ID Number</h6></label>
                                                                            <input type="text" class="form-control" id="sap_id" name="sap_id" value="{{ old('sap_id') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mt-2 mb-1">
                                                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                                ...
                                                <div class="tab-pane fade" id="pills-ExistingEmployee" role="tabpanel" aria-labelledby="pills-ExistingEmployee-tab">
                                                    {{-- Existing Employee --}}
                                                        <form action="/hr/create-user" method="POST" onsubmit="submitButtonDisabled()">
                                                            @csrf
                                                            <div class="row ps-5 p-3 pe-5 text-dark">
                                                                <div class="col-lg-6 col-md-6 col-sm-12 border-start border-warning border-5">
                                                                    ...
                                                                    <div class="row mt-2 mb-1">
                                                                        <div class="col">
                                                                            <label for="date_hired"><h6 class="profile-title">Birth date</h6></label>
                                                                            <input type="date" class="form-control" id="birthdate" name="birthdate" value="{{ old('date_hired') }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-12 border-start border-warning border-5">
