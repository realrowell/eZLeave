                                            ...
                                            @if ($user->employees->employee_positions->positions->position_levels->id != 'psl-1002' && $user->employees->employee_positions->positions->position_levels->id != 'psl-1001')
                                                @if ( !empty(optional($user->employees->employee_positions)->reports_to_id))
                                                    ...
                                                    @foreach ($user_reports_tos as $user_reports_to)
                                                        @if (optional(optional(optional(optional($user_reports_to->employee_positions)->positions)->subdepartments)->departments)->id == optional(optional(optional(optional(optional($user->employees)->employee_positions)->positions)->subdepartments)->departments)->id)
                                ...
                                <div class="row mt-3 mb-1">
                                    <div class="mb-2 col-lg-3 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="position" name="position">
                                            <option selected value="{{ $user->employees->employee_positions->position_id }}">{{ optional($user->employees->employee_positions->positions)->position_description }}</option>
                                            @foreach ($positions as $position)
                                                @if ($position->id != $user->employees->employee_positions->position_id)
                                    ...
                                    <div class="mb-2 col-lg-3 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="area_of_assignment" name="area_of_assignment">
                                            <option selected value="{{ $user->employees->employee_positions->area_of_assignment_id }}">{{ optional($user->employees->employee_positions->area_of_assignments)->location_address }}</option>
                                            @foreach ($area_of_assignments as $area_of_assignment)
                                                @if ($area_of_assignment->id != $user->employees->employee_positions->area_of_assignment_id)
