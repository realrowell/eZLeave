            ...
            <div class="row bg-light mt-2 z-1 p-1 ps-4 m-1 shadow">
                <div class="row justify-content-start align-items-start text-start">
                    <div class="col">
                        ...
                        <a href="{{ route('visit_employee_leave_ms_view',['username'=>$user->user_name]) }}" class="ms-1 me-1 p-2 custom-primary-button @yield('grid_active') ">
                            Leave MS
                        </a>
                    </div>
                </div>
                                    ...
                                    <div class="mb-2 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="reports_to" name="reports_to">
                                            ...
                                            @else
                                                <option selected disabled > - Please Select - </option>
                                                @foreach ($user_reports_tos as $user_reports_to)
                                                    @if (optional(optional(optional($user_reports_to->employees)->employee_positions)->positions)->position_level_id == optional(optional(optional($user->employees)->employee_positions)->positions)->position_level_id || optional(optional(optional($user_reports_to->employees)->employee_positions)->positions)->position_level_id <= optional(optional($user->employees->employee_positions)->positions)->position_level_id)
                                                        <option value="{{ optional($user_reports_to->employees)->id }}">
                                                            {{ $user_reports_to->last_name .', '}}
                                                            {{ $user_reports_to->first_name }}
                                                            {{ $user_reports_to->middle_name }}
                                        ...
                                        <select class="form-control" id="second_reports_to" name="second_reports_to">
                                            ...
                                            {{-- @if (optional(optional($user->employees->employee_positions)->positions)->position_level_id != 'psl-1002' && optional(optional($user->employees->employee_positions)->positions)->position_level_id != 'psl-1001')
                                                @if ( !empty(optional($user->employees->employee_positions)->reports_to_id))
                                                    ...
                                                    @foreach ($user_reports_tos as $user_reports_to)
                                                        @if (optional(optional(optional(optional($user_reports_to->employees)->employee_positions)->positions)->subdepartments)->department_id == optional(optional(optional($user->employees->employee_positions)->positions)->subdepartments)->department_id)
                                                            <option value="{{ $user_reports_to->employees->id }}">
                                                                {{ $user_reports_to->last_name .', '}}
                                                                {{ $user_reports_to->first_name }}
                                                                {{ $user_reports_to->middle_name }}
                                                            </option>
                                            ...
                                            @else
                                                <option selected disabled > - Please Select - </option>
                                                @foreach ($user_reports_tos as $user_reports_to)
                                                    @if (optional(optional(optional($user_reports_to->employees)->employee_positions)->positions)->position_level_id == optional(optional($user->employees->employee_positions)->positions)->position_level_id || optional(optional(optional($user_reports_to->employees)->employee_positions)->positions)->position_level_id <= optional(optional($user->employees->employee_positions)->positions)->position_level_id)
                                                        <option value="{{ optional($user_reports_to->employees)->id }}">
                                                            {{ $user_reports_to->last_name .', '}}
                                                            {{ $user_reports_to->first_name }}
                                                            {{ $user_reports_to->middle_name }}
