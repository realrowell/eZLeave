...
<div class="container-fluid mb-4 pb-5" id="profile_body">
    ...
    <div class="row mb-4 d-flex gap-1 justify-content-center justify-content-sm-center justify-content-lg-start">
        ...
        <div class="col-lg-2 col-md-4 col-sm-5 col-5 card-menu shadow-sm align-self-stretch bg-selected-warning" style="min-height: 1rem" >
            <a href="/admin/organization/positions/grid" class="text-light">
                <div class="col text-light-hover">
                    <div class="card-body">
                        <h6>Positions</h6>
                    </div>
        ...
        <div class="col-lg-2 col-md-4 col-sm-5 col-5 card-menu shadow-sm align-self-stretch" style="min-height: 1rem" >
            <a href="/admin/organization/area_of_assignments/grid" class="text-dark">
                <div class="col text-light-hover">
                    <div class="card-body">
    ...
    <div class="row mb-3">
        <div class="col-sm-12 col-md-4 col-lg-6 mt-2">
            <h3><a href="/admin/organization/menu" class="text-dark">Organization</a> / Employee Positions</h3>
        </div>
        <div class="col-sm-12 col-md-8 col-lg-6 justify-content-end align-items-end text-end mt-2">
            <a href="/admin/organization/positions/grid" class="col p-2 custom-primary-button custom-rounded-top @yield('grid_active') ">
            ...
            <a href="/admin/organization/positions/list" class="col p-2 ms-2 custom-primary-button custom-rounded-top @yield('list_active')">
    ...
    <!-- Add Position Modal -->
    <div class="modal fade" id="create_position" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/organization/create_position" method="POST" onsubmit="submitButtonDisabled()">
                    @csrf
                        ...
                        <div class="container-fluid text-start">
                            <div class="row mt-2 mb-3" >
                                <div class="col">
                                    ...
                                    <textarea class="form-control" id="position_description" name="position_description" rows="10" cols="50" required></textarea>
                                    {{-- <label class="mt-3" for="subdepartment_title"><h6 class="profile-title">Sub-department</h6></label>
                                    <select id="subdepartment_title" name="subdepartment_title" class="form-control" required maxlength="50">
