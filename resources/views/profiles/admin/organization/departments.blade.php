...
<div class="container-fluid mb-4 pb-5" id="profile_body">
    <div class="row mb-4 p-4 card shadow align-self-stretch">
        <div class="col ">
            <div class="row">
    ...
    <div class="row mb-4 d-flex gap-1 justify-content-center justify-content-sm-center justify-content-lg-start">
        <div class="col-lg-2 col-md-4 col-sm-5 col-5 card-menu shadow-sm align-self-stretch bg-selected-warning" style="min-height: 1rem" >
            <a href="{{ route('admin_departments_grid') }}" class="text-light">
    ...
    <div class="row mb-3">
        <div class="col-sm-12 col-md-4 col-lg-6 mt-2">
            <h3><a href="{{ route('admin_org_menu') }}" class="text-dark">Organization</a> / Departments</h3>
        </div>
        <div class="col-sm-12 col-md-8 col-lg-6 justify-content-end align-items-end text-end mt-2">
            <a href="{{ route('admin_departments_grid') }}" class="col p-2 custom-primary-button custom-rounded-top @yield('grid_active') ">
            ...
            <a href="{{ route('admin_departments_list') }}" class="col p-2 ms-2 custom-primary-button custom-rounded-top @yield('list_active')">
            ...
            <a href="#AddDept" class="col p-2 ms-2 custom-primary-button custom-rounded-top"  data-bs-toggle="modal" data-bs-target="#create_department">
