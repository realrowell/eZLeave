...
<div class="container-fluid " id="profile_body">
    <div class="row mb-2 d-flex gap-1 justify-content-center justify-content-sm-center justify-content-lg-start d-print-none">
        ...
        <div class="col-lg-2 col-md-4 col-sm-5 col-5 card-menu shadow-sm align-self-stretch @yield('menu_queue_info')" style="min-height: 1rem" >
            <a href="{{ route('queue.info') }}" class="@yield('menu_queue_info')">
                <div class="col text-light-hover">
                    <div class="card-body">
                        <h6>Queue Info</h6>
                    </div>
