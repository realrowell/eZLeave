            ...
            <div class="modal-footer">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <form action="{{ route('account_deactivate',['username'=>$username]) }}" method="PUT" onsubmit="onClickApprove()">
                                @csrf
                                <button class="btn btn-danger rounded-0" type="submit">Confirm Deactivation</button>
                            </form>
                        </div>
                    </div>
                </div>
