    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border border-5 border-warning border-top-0 border-bottom-0 border-end-0 rounded-0">
                ...
                <div class="container-fluid text-start">
                    ...
                    <div class="row mt-5 mb-5">
                        <div class="col text-center">
                            <h2>Please confirm to delete selected leave type</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <form action="{{ route('admin.delete.leavetype',['leavetype_id'=>$leavetype->id]) }}" method="POST" onsubmit="onClickApprove()">
                    @csrf
