<div class="modal fade" id="ExportFilterModal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border border-end-0 border-top-0 border-bottom-0 border-warning border-5 rounded-0">
            <form action="{{ route('leave.application.export.wizard') }}" method="GET" >
                @csrf
                    ...
                    <div class="container-fluid text-start">
                        <div class="row pt-3 pb-3">
                            <div class="col">
                                ...
                                <div class="row ">
                                    <div class="col">
                                        <label for="startdate_coverage1">Date Coverage</label>
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col">
                                        <label for="startdate" class="float-end">Start date</label>
                                        <input type="date" class="form-control" name="startdate_coverage" id="startdate">
                                    </div>
                                    <div class="col">
                                        <label for="enddate" class="float-end">End date</label>
                                        <input type="date" class="form-control" name="enddate_coverage" id="enddate">
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col">
...
<script>
    $(document).ready(function(){
        $('#department').on('change',function(){
            ...
            $('#subdepartment').append('<option value="" disabled selected >Processing...</option>');
            $.ajax({
                type: 'GET',
                ...
                success: function (response){
                    ...
                    $('#subdepartment').append('<option value="" selected> All </option>');
