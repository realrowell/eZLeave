...
class LeaveAppUpdateModal extends Component
{
     ...
     */
    public function __construct($leaveReferenceNumber, $leaveTypeTitle, $leaveDuration, $leaveStart, $leaveStartPart,
    ...
    {
        return view('components.employee.leave-app-update-modal');
    }
}
