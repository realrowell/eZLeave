...
class LeaveAppPartialApproved extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Your Leave Application has been Partially Approved',
        );
    }
    ...
    {
        return new Content(
            view: 'email.employee.leave_app_partialApproved',
        );
    }
